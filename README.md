...
# 50427wxapp新冠抗原自测平台小程序

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1NvtMeFEiw?p=87)


# 第1章 绪论
## 1.1 课题背景
互联网发展至今，无论是其理论还是技术都已经成熟，而且它广泛参与在社会中的方方面面。它让信息都可以通过网络传播，搭配信息管理工具可以很好地为人们提供服务。所以各行业，尤其是规模较大的企业和学校等都开始借助互联网和软件工具管理信息，传播信息，共享信息等等，以此可以增强自身实力，提高在同行业当中的竞争能力，并从各种激烈的竞争中获取发展的机会。针对高校教师成果信息管理混乱，出错率高，信息安全性差，劳动强度大，费时费力等问题，经过分析和考虑，在目前的情况下，可以引进一款新冠抗原自测平台小程序这样的现代化管理工具，这个工具就是解决上述问题的最好的解决方案。它不仅可以实时完成信息处理，还缩短高校教师成果信息管理流程，使其系统化和规范化。同时还可以减少工作量，节约高校教师成果信息管理需要的人力和资金。所以新冠抗原自测平台小程序是信息管理环节中不可缺少的工具，它对管理者来说非常重要。
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对高校教师成果信息管理，采用新冠抗原自测平台小程序可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用新冠抗原自测平台小程序，其意义如下：

第一点：新冠抗原自测平台小程序的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对新冠抗原自测平台小程序设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对新冠抗原自测平台小程序进行介绍时，将按照如下内容进行。

第一部分：介绍新冠抗原自测平台小程序研究的背景意义，便于用户了解系统；

第二部分：介绍开发新冠抗原自测平台小程序需要搭建的环境，包括技术和工具；

第三部分：介绍用户对新冠抗原自测平台小程序的功能要求，以及对新冠抗原自测平台小程序的性能要求等；
...
# 第2章 开发环境与技术
新冠抗原自测平台小程序的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对新冠抗原自测平台小程序用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，新冠抗原自测平台小程序开发可行。
### 3.1.3 操作可行性
新冠抗原自测平台小程序根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作新冠抗原自测平台小程序。
...
![C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\新冠抗原.jpg](/md/blog.006.jpeg "C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\新冠抗原.jpg")
新冠抗原实体属性图

（2）下图是用户实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\用户.jpg](/md/blog.007.jpeg "C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\用户.jpg")
用户实体属性图

（3）下图是新冠抗原订单实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\新冠抗原订单.jpg](/md/blog.008.jpeg "C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\新冠抗原订单.jpg")
新冠抗原订单实体属性图

（4）下图是论坛实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\论坛.jpg](/md/blog.009.jpeg "C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\论坛.jpg")
论坛实体属性图

（5）下图是新冠抗原收藏实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\新冠抗原收藏.jpg](/md/blog.010.jpeg "C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\新冠抗原收藏.jpg")
新冠抗原收藏实体属性图

（6）下图是防护知识收藏实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\防护知识收藏.jpg](/md/blog.011.jpeg "C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\防护知识收藏.jpg")
防护知识收藏实体属性图

（7）下图是防护知识实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\防护知识.jpg](/md/blog.012.jpeg "C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\防护知识.jpg")
防护知识实体属性图

（8）下图是公告通知实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\公告通知.jpg](/md/blog.013.jpeg "C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\公告通知.jpg")
公告通知实体属性图

（9）下图是检测记录实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\检测记录.jpg](/md/blog.014.jpeg "C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\检测记录.jpg")
检测记录实体属性图

（10）下图是防护知识留言实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\防护知识留言.jpg](/md/blog.015.jpeg "C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\防护知识留言.jpg")
防护知识留言实体属性图

（11）下图是新冠抗原留言实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\新冠抗原留言.jpg](/md/blog.016.jpeg "C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\新冠抗原留言.jpg")
新冠抗原留言实体属性图

（12）下图是收货地址实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\收货地址.jpg](/md/blog.017.jpeg "C:/Users/Administrator/Desktop/temp111\3\\_\_\_\_img\收货地址.jpg")
收货地址实体属性图
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|fanghuzhishi\_name|String|知识标题|是|
|3|fanghuzhishi\_types|Integer|知识类型|是|
|4|fanghuzhishi\_photo|String|知识图片|是|
|5|fanghuzhishi\_video|String|视频|是|
|6|zan\_number|Integer|赞|是|
|7|cai\_number|Integer|踩|是|
|8|fanghuzhishi\_clicknum|Integer|点击量|是|
|9|insert\_time|Date|添加时间|是|
|10|fanghuzhishi\_content|String|知识详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|fanghuzhishi\_id|Integer|防护知识|是|
|3|yonghu\_id|Integer|用户|是|
|4|fanghuzhishi\_collection\_types|Integer|类型|是|
...
|2|fanghuzhishi\_id|Integer|防护知识|是|
|3|yonghu\_id|Integer|用户|是|
|4|fanghuzhishi\_liuyan\_text|String|留言内容|是|
...
|3|jiance\_name|String|标题|是|
|4|jiance\_photo|String|检测图片|是|
|5|jiance\_types|Integer|检测结果|是|
|6|jiance\_time|Date|检测时间|是|
|7|insert\_time|Date|添加时间|是|
|8|jiance\_text|String|备注|是|
|9|create\_time|Date|创建时间|是|
表4.8公告通知表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|xinguankangyuan\_uuid\_number|String|新冠抗原编号|是|
|3|xinguankangyuan\_name|String|新冠抗原名称|是|
|4|xinguankangyuan\_photo|String|新冠抗原照片|是|
|5|xinguankangyuan\_types|Integer|新冠抗原类型|是|
|6|xinguankangyuan\_kucun\_number|Integer|新冠抗原库存|是|
|7|xinguankangyuan\_old\_money|BigDecimal|新冠抗原原价|是|
|8|xinguankangyuan\_new\_money|BigDecimal|现价/积分|是|
|9|xinguankangyuan\_clicknum|Integer|新冠抗原热度|是|
|10|xinguankangyuan\_content|String|新冠抗原介绍|是|
|11|shangxia\_types|Integer|是否上架|是|
|12|xinguankangyuan\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|xinguankangyuan\_id|Integer|新冠抗原|是|
|3|yonghu\_id|Integer|用户|是|
|4|xinguankangyuan\_collection\_types|Integer|类型|是|
|5|insert\_time|Date|收藏时间|是|
|6|create\_time|Date|创建时间|是|
表4.11新冠抗原留言表
...
|2|xinguankangyuan\_id|Integer|新冠抗原|是|
|3|yonghu\_id|Integer|用户|是|
|4|xinguankangyuan\_liuyan\_text|String|留言内容|是|
|5|insert\_time|Date|留言时间|是|
|6|reply\_text|String|回复内容|是|
|7|update\_time|Date|回复时间|是|
|8|create\_time|Date|创建时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|xinguankangyuan\_order\_uuid\_number|String|订单编号|是|
|3|address\_id|Integer|收货地址|是|
|4|xinguankangyuan\_id|Integer|新冠抗原|是|
|5|yonghu\_id|Integer|用户|是|
|6|buy\_number|Integer|购买数量|是|
|7|xinguankangyuan\_order\_true\_price|BigDecimal|实付价格|是|
|8|xinguankangyuan\_order\_types|Integer|订单类型|是|
|9|xinguankangyuan\_order\_payment\_types|Integer|支付类型|是|
...
图5.1 用户信息管理页面
### 5.2 防护知识管理
如图5.2显示的就是防护知识管理页面，此页面提供给管理员的功能有：查看已发布的防护知识数据，修改防护知识，防护知识作废，即可删除，还进行了对防护知识名称的模糊查询 防护知识信息的类型查询等等一些条件。
...
图5.2 防护知识管理页面
### 5.3新冠抗原管理
如图5.3显示的就是新冠抗原管理页面，此页面提供给管理员的功能有：根据新冠抗原进行条件查询，还可以对新冠抗原进行新增、修改、查询操作等等。
